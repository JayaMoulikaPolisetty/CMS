...
class DeveloperController extends Controller
{
  public function __construct()
	...
	public function view()
  	{	
        $inp=\App\Post::all();
    		return view('cms/developer',compact('inp',$inp));
    }
  public function index()
    {
        ...
        if(Request::get('demo')) 
          {
            $reg->i=1;
            return view('cms/view',compact('reg','reg1'));     
          } 
  ...
  public function viewdev()
    {
	     ...
	     return view('cms/viewdev',compact('inp',$inp));
    }
  ...
  public function viewd()
    {
      ...
      elseif(Request::get('edit')) 
        {
          $inp=\App\developers::all();
         return view('cms/editor',compact('reg1','inp'));
        }
